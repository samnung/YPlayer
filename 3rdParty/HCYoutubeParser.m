...
+ (void)thumbnailForYoutubeURL:(NSURL *)youtubeURL
				 ...
				 completeBlock:(void(^)(NSImage *image, NSError *error))completeBlock {
#else
+ (void)thumbnailForYoutubeURL:(NSURL *)youtubeURL
                 thumbnailSize:(YouTubeThumbnail)thumbnailSize
...
#ifdef TARGET_OS_MAC
+ (void)thumbnailForYoutubeID:(NSString *)youtubeID thumbnailSize:(YouTubeThumbnail)thumbnailSize completeBlock:(void (^)(NSImage *, NSError *))completeBlock {
#else
